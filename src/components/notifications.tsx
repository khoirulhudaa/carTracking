// components/pages/NotificationCenter.tsx
import { AlertTriangle, BellRing, Calendar, CheckCircle, Fuel, Siren, Wrench } from 'lucide-react';

export default function NotificationCenter() {
  const notifications = [
    { id: 1, type: 'fuel', title: 'Bahan Bakar Rendah', desc: 'B 2345 MNO hanya tersisa 15%', time: '10 menit lalu', read: false },
    { id: 2, type: 'service', title: 'Service Overdue', desc: 'B 7890 JKL sudah lewat 1.200 km', time: '2 jam lalu', read: false },
    { id: 3, type: 'emergency', title: 'Emergency Button Ditekan', desc: 'Driver Budi P. (B 9012 DEF)', time: '1 hari lalu', read: true },
    { id: 4, type: 'geofence', title: 'Keluar Area', desc: 'B 1234 ABC keluar zona kantor', time: '3 hari lalu', read: true },
  ];
    ...
    <div className="min-h-screen bg-white rounded-xl py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
            ...
            <button className="text-blue-600 hover:underline text-sm font-medium">Tandai semua telah dibaca</button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <p className="text-gray-600">Belum Dibaca</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 border text-center">
            ...
            <p className="text-gray-600">Total Bulan Ini</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 border text-center">
            ...
            <p className="text-gray-600">Reminder Hari Ini</p>
            </div>
        </div>

        <div className="bg-white rounded-2xl shadow-sm p-6 border">
            <h3 className="text-xl font-bold text-gray-800 mb-6">Semua Notifikasi</h3>
            ...
            {notifications.map((n) => {
                ...
                return (
                <div key={n.id} className={`p-5 rounded-xl border ${n.read ? 'bg-gray-50 border-gray-200' : 'bg-white border-gray-300 shadow-sm'}`}>
                    ...
                    <div className="flex-1">
                        <p className={`font-bold ${n.read ? 'text-gray-600' : 'text-gray-800'}`}>{n.title}</p>
