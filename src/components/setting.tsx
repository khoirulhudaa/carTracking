// components/pages/Settings.tsx (full diperbaiki)
import { Bell, Clock, Database, Fuel, Globe, Key, Lock, Mail, MessageSquare, QrCode, Settings, Shield, Smartphone, Users } from 'lucide-react';

export default function SettingsPage() {
  return (
    <div className="min-h-screen bg-white rounded-xl py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        <h1 className="text-3xl font-bold text-gray-800">Settings / Pengaturan</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Role & Permission Management</h3>
            </div>

            <div className="space-y-4">
                {['Admin', 'Kepala Dinas', 'Pengawas', 'Mekanik', 'Driver'].map((role) => (
                <div
                    key={role}
            ...
            <div className="mt-7 pt-6 border-t border-gray-200">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                    <p className="font-medium text-gray-800">Multi-Factor Authentication (MFA)</p>
                    <p className="text-sm text-gray-600">Wajib untuk Admin & Kepala Dinas</p>
                    </div>
                </div>
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Vehicle Threshold Settings</h3>
            </div>

            <div className="space-y-6">
                <div>
                <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
                    <Fuel className="w-4 h-4" /> Fuel Low Alert
                </label>
                <input
                    type="range"
                    min="5"
                ...
                <div>
                    <label className="text-sm font-medium text-gray-700">Max Speed Limit</label>
                ...
                <div>
                    <label className="text-sm font-medium text-gray-700">Service Interval</label>
                    <div className="flex items-center mt-1">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Notification Channels</h3>
            </div>
            ...
            <div className="space-y-5">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium">Push Notification (App)</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium">SMS (Critical Only)</span>
                </div>
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">QR Code Management</h3>
            </div>
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">Backup & Security Summary</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                ...
                <p className="text-sm text-gray-600">Uptime Bulan Ini</p>
                </div>
                <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                <Key className="w-10 h-10 text-blue-600 mx-auto mb-3" />
                <p className="text-3xl font-bold text-blue-700">Daily</p>
                ...
                <p className="text-3xl font-bold text-orange-700">2 Lokasi</p>
