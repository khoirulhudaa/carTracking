      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            {/* <p className="text-gray-600 mt-1">Real-time logistics & delivery monitoring</p> */}
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{stats.totalFuel} L</p>
                <div className="mt-3 h-12">
                  <Chart options={fuelTrendOptions} series={fuelTrendSeries} type="area" height={48} />
                </div>
              </div>
